/*! For license information please see bs-stepper.js.LICENSE.txt */ ! function () {
  var e = {
      7082: function (e) {
        e.exports = function () {
          "use strict";
            ...
            h = function (e, t, n, s, o) {
              ...
              if (t.classList.contains(l)) {
                ...
                t.addEventListener(p, (function n() {
                  t.classList.add(c), t.removeEventListener(p, n), e.dispatchEvent(f), o()
                })), s.length && s[0].classList.add(a), t.classList.add(r), m(t, v)
              } else t.classList.add(r), t.classList.add(c), e.dispatchEvent(f), o()
            },
            _ = function (e) {
              if (!e) return 0;
          ...
          return function () {
            ...
            return s._setLinkListeners = function () {
              ...
              })), this._element.bsStepper = void 0, this._element = void 0, this._currentIndex = void 0, this._steps = void 0, this._stepsContents = void 0, this._clickStepLinearListener = void 0, this._clickStepNonLinearListener = void 0
            }, t
          }()
        }()
      }
