            ...
            <form action="{{ route('menus.store') }}" method="POST" id="form">
              ...
              <div class="mb-3">
                ...
                <select name="upid_menus" id="upid_menus" class="form-control select2" style="width: 100%">
                  ...
                  @foreach ($menus as $item)
                    <option value="{{ $item->id_menus }}">{{ $item->name_menus }}</option>
                  @endforeach
                </select>
              </div>
              ...
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <input type="text" class="form-control" id="link_menus" name="link_menus"
                    aria-describedby="basic-addon34" value="{{ old('link_menus') }}">
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="icon_menus" name="icon_menus"
                  placeholder="Masukkan icon menu" value="{{ old('icon_menus') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control input-tags" id="action_menus" name="action_menus"
                  placeholder="Masukkan aksi menu" value="{{ old('action_menus') }}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control" name="description_menus" id="description_menus" cols="20" rows="5"
                  placeholder="Masukkan deskripsi menu">{{ old('description_menus') }}</textarea>
              </div>
