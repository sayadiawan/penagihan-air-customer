    ...
    <div class="app-brand demo">
        <a href="/" class="app-brand-link text-left">
            <span class="app-brand-logo demo">
                ...
                <img src="{{ asset('admin-assets/assets/img/logotirta.png') }}" width="50" viewBox="0 0 25 42"
                    alt="" />

            </span>

            <span class="app-brand-text demo menu-text fw-bolder ms-2">Graha <br> Mandiri</span>
        </a>
